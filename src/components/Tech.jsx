...
import { SiMysql, SiMongodb, SiGit, SiLinux } from 'react-icons/si';
    ...
    <div id="tech" className='flex min-h-[70vh] w-full flex-col items-center justify-center gap-16 md:gap-32'>
      ...
      <div className="flex flex-wrap items-center justify-center gap-10 p-5">
        ...
        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.25 }}>
          <SiMongodb className="cursor-pointer text-[80px] text-green-600 transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.35 }}>
          <SiLinux className="cursor-pointer text-[80px] text-black transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
        ...
        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.45 }}>
          <SiGit className="cursor-pointer text-[80px] text-red-500 transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>

        <motion.div variants={variants} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.5 }}>
          <DiAws className="cursor-pointer text-[80px] text-orange-500 transition-all duration-300 hover:translate-y-5 sm:text-[100px] md:text-[120px]" />
        </motion.div>
